...
import com.astonrest.dao.mapper.impl.UserResultSetMapperImpl;;
...
public class UserDaoImpl implements BaseDao<User>, UserDao {
    ...
    public static final String INSERT_USER =
            """
                    INSERT 
                    INTO tool_box.users(user_id,login,password,name,surname,users_role) 
                    VALUES (?,?,?,?,?,?) """;
    ...
    public static final String UPDATE_USER =
            """
                    UPDATE tool_box.users 
                    SET login=?,password=?,name=?,surname=? 
                    WHERE user_id=?""";
    ...
    public static UserDao getUserDao(ConnectionManager connectionManager) {
        if (userDao == null) {
