...
class ProductDaoImplTest {
    ...
    void setUp() {
        ...
        productDao = ProductDaoImpl.getProductDao(connectionManager);
    ...
    void successfulFindAllProducts() throws DaoException {
        ...
        Assertions.assertEquals(productList, baseDao.findAll());
    }
    ...
    void unsuccessfulFindAllProducts() throws DaoException {
        ...
        productList.add(product2);
        productList.add(product3);
        Assertions.assertNotEquals(productList, baseDao.findAll());
    }
    ...
    void successfulUpdate() throws DaoException {
        ...
        ProductDescription description = new ProductDescription
                ...
                .build();
        product.setDescription(description);
        Assertions.assertTrue(baseDao.update(product));
    }
    ...
    void unsuccessfulUpdate() throws DaoException {
        ...
        ProductDescription description = new ProductDescription
                ...
                .build();
        product.setDescription(description);
        Assertions.assertFalse(baseDao.update(product));
    }
    ...
    void successfulInsert() throws DaoException {
        ...
        ProductDescription description = new ProductDescription
                ...
                .build();
        product.setDescription(description);
        Assertions.assertTrue(baseDao.insert(product));
    }
    ...
    void unsuccessfulInsert() throws DaoException {
        ...
        Assertions.assertThrows(DaoException.class, () -> baseDao.insert(product));
    }
    ...
    void successfulDelete() throws DaoException {
        ...
        ProductDescription description = new ProductDescription
                ...
                .build();
        product.setDescription(description);
        Assertions.assertTrue(baseDao.delete(product));
    }
    ...
    void unsuccessfulDelete() throws DaoException {
        ...
        ProductDescription description = new ProductDescription
                ...
                .build();
        product.setDescription(description);
        Assertions.assertFalse(baseDao.delete(product));
    }
    ...
    void insertIfProductNull() throws DaoException {
        product = null;
        Assertions.assertFalse(baseDao.insert(product));
    }
